...
def kresba():
    ...
    # Nadepsání bodů
    canvas.create_text(a_x-20,a_y-30,fill="black",font="Times 20",text="A",anchor="w")
    ...
    canvas.create_text(strana_A/2,(a_y-b_x)+30,fill="black",font="Times 20",text="a")
    canvas.create_text(strana_B/2,(b_y-c_y)+20,fill="black",font="Times 20",text="b")
    canvas.create_text(strana_C/2,(a_y-c_y)+20,fill="black",font="Times 20",text="c")
