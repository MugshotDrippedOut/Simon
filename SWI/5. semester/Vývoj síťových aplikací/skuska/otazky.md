...
- Která z následujících anotací ve Springu se používá pro označení třídy, která by měla být zaregistrována jako komponenta pro práci s konkrétní kolekcí dat v databází? - @Repository
  <!-- 17 -->
...
- Které z následujících problémů mohou způsobit odmítnutí příjemce při odesílání emailu?
  ...
  - Nespravná formatovaná emailová adresa. v
...
- Je kód pro REST kontrolér napsán bez chyb?
  ...
  public class ProductController {
      ...
      public ResponseEntity<List<Product>> getAllProducts() {
          List<Product> products = productService. findA11();
